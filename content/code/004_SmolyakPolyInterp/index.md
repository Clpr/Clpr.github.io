---
title: "Smolyak Polynomial Interpolation in Practice"
date: 2026-04-18T00:00:01-07:00
...
showSummary: true
summary: "A python module for defining, training, updating and I/O of Smolyak-Chebyshev polynomial interpolation. Also implements standard interpolation methods like basis matrix and coefficients."
...
**Python files**:
- [smolyakpoly.py](SmolyakPolyInterp/smolyakpoly.py): the module file. Check `SmolyakPolyInterp` class for usage examples and parameter settings
- [test.py](SmolyakPolyInterp/test.py): tests
- [smolyakpoly_demo.ipynb](SmolyakPolyInterp/smolyakpoly_demo.ipynb): 2-D examples and illustration
- [smolyakpoly_benchmark.ipynb](SmolyakPolyInterp/smolyakpoly_benchmark.ipynb): benchmarking by dimensionality and interpolation accuracy


> **AI claimer**: This project is developed with help of ChatGPT Codex function subscribed by the author.
...
$$
\mathcal{I}(n,\mu) = \left\{\ell \in \mathbb{N}^n : \ell_i \ge 1,\;n \le |\ell|_1 \le n + \mu\right\},
$$
...
$$
\mathcal{I}_{\text{aniso}}(n,\mu,L)=\left\{\ell \in \mathbb{N}^n :1 \le \ell_i \le L_i,\;n \le |\ell|_1 \le n + \mu\right\}.
$$
...
$$
\frac{\partial^2 \Psi_{\nu}}{\partial z_j^2}(z) = T''_{\nu_j}(z_j)\prod_{i \ne j} T_{\nu_i}(z_i),
$$

$$
\frac{\partial^2 \Psi_{\nu}}{\partial z_j \partial z_k}(z) = T'_{\nu_j}(z_j)T'_{\nu_k}(z_k)\prod_{i \ne j,k} T_{\nu_i}(z_i).
$$
