...
# load script: US university auto-complete
with codecs.open("asset/headscript01_autoUSuniv.txt","r",encoding="utf8") as fp:
    htmlstr.append( fp.read() )
# load script: research field auto-complete
with codecs.open("asset/headscript02_autofield.txt","r",encoding="utf8") as fp:
    htmlstr.append( fp.read() )
# load script: world university auto-complete
with codecs.open("asset/headscript03_autoWorlduniv.txt","r",encoding="utf8") as fp:
    htmlstr.append( fp.read() )


# load script: world university auto-complete !!!!!!!
with codecs.open("asset/headscript04_saveContentAsFile.txt","r",encoding="utf8") as fp:
    htmlstr.append( fp.read() )
