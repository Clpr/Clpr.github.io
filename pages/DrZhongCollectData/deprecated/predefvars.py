...
li_worktitle_teach = [
    ...
    'Visiting Professor',   'Visiting Assistant Professor',   'Research Assistant Professor', 'Emeritus',
    'Other',
]
...
li_worktitle_nonteach = [
    ...
    'Consultant/Advisory', 'Visiting Scholar', 'Senior Research Fellow','Research Fellow','Junior/Associate Research Fellow',
...
li_workinstituiontype_nonteach = [
    'Unknown',
    'Government', 'Non-gov Org (NGO)', 'Industry',
    'Other',
]
